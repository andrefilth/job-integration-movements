...
@Log4j2
@AllArgsConstructor
public class AsnOutThread implements Runnable {

	private String caminho;

	private Services expedicaoService;

	private MovimentosInventarioService movimentosService;

	@Override
	public void run() {
		CodeType type = CodeType.ASNOUT;
		...
		new Thread(() -> {
			try {
				...
				while (br.ready()) {
					...
					ValidandoMovimentos movimentos = new ValidandoMovimentos(linha, expedicaoService);
